...
var Auth = connect(function (store) {
    return {
...
var AuthProvider = function AuthProvider(props) {
    return React.createElement(
        ApolloProvider,
        _extends({ client: createClient(_extends({}, props)) }, props),
...
var index = {
    ...
    Login: Login$1,
    Logout: Logout,
    PasswordHelp: PasswordHelp$1,
    Registration: Registration$1,
    RegisterApplication: RegisterApplication$1
};
